...
@section('others')
    <div class="container px-0">
        <div class="d-flex justify-content-between">
            ...
            <a href="{{ route('instructor.class.create', ['assignment_students' => $assignment_students->id, 'slug' => 'modules']) }}"
                class="btn btn-lg btn-primary mb-3">Tambah</a>
        </div>
        <div class="row gx-5">
            @foreach($modules as $module)
                <div class="col-md-6">
                    <a href="XXX" class="text-decoration-none">
